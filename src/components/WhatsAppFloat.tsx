...
export default function WhatsAppFloat() {
  const whatsappUrl = getWhatsAppLink('Olá! Estou navegando no site da Virtuan Consertos e gostaria de falar imediatamente com o técnico de plantão.');
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      <motion.a
        ...
        onClick={() => trackWhatsAppConversion(whatsappUrl)}
        animate={{
          scale: [1, 1.1, 1],
          rotate: [0, 360],
        }}
